...
#import "LKAddressPickViewTableViewCell.h"
...
@interface LKAddressPickerView()<UITableViewDelegate,UITableViewDataSource>
{
    UILabel *titleLabel;
...
-(void)setType:(enum EWLocationPickViewTableViewType)type{
    ...
    switch (type) {
        ...
        case city:
        {
            ...
            [UIView animateWithDuration:0.3 animations:^{
                self->underLine.center = CGPointMake(self.buttonArray[1].center.x, self->underLine.center.y);
            }];
            ///tableView加载城市数据
        ...
        case area:
            ...
            [UIView animateWithDuration:0.3 animations:^{
                self->underLine.center = CGPointMake(self.buttonArray[2].center.x, self->underLine.center.y);
            }];
    ...
    [tableView scrollToRowAtIndexPath:indexPat atScrollPosition:UITableViewScrollPositionBottom animated:NO];
}
/**
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0){
        LKAddressPickViewTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
        if (!cell){
            cell = [[LKAddressPickViewTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
        }
        cell.label.text = @"请选择";
        return cell;
    }
    
    LKAddressPickViewFirstTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID2];
    if (!cell){
        cell = [[LKAddressPickViewFirstTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID2];
    }
