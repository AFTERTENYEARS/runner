...
#import "LKAddressViewController.h"
#import "LKAddressPickerPresentAnimated.h"

@interface LKAddressViewController () <UIViewControllerTransitioningDelegate>

@end

@implementation LKAddressViewController
...
- (void)drawMyView{
    ...
    _containV = [[LKAddressPickerView alloc]initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 550, [UIScreen mainScreen].bounds.size.width, 550) selectColor:selectColor];
    ///弱引用,防止循环引用
...
-(id<UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source{
    LKAddressPickerPresentAnimated *animated = [[LKAddressPickerPresentAnimated alloc] initWithType:present];
    return animated;
}
///推出动画
-(id<UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed{
    LKAddressPickerPresentAnimated *animated = [[LKAddressPickerPresentAnimated alloc] initWithType:dismiss];
    return animated;
}
