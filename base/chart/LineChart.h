...
/******************* 折线属性 ***************************/
/**折线图上的数据*/
@property (nonatomic, strong) NSArray <LineChartData *> *lineChartDatas;
/** 是否有动画，默认YES */
...
/** 竖线位置*/
@property (nonatomic, assign) CGFloat verticalLineIndex;

/******************* Method ***************************/
/** 画折线图 */
- (void)strokeChart;
/** 更新折线图
 @param datas LineChart数组
 */
- (void)updateChartDatas:(NSArray <LineChartData *> *)datas;
